...
{{/*
Return the proper clusterpedia storage image name
*/}}
...
*/}}
{{- define "clusterpedia.initContainer.image" -}}
{{ include "common.images.image" (dict "imageRoot" .Values.storage.initContainerImage "global" .Values.global) }}
{{- end -}}
